module.exports = (robot) ->
    robot.respond /^tell me a joke/i, (res) ->
        res.reply "In a purple galaxy, in a purple solar system, orbiting a purple star, there is a purple planet.\n\n"+
                  ...
                  "princess Purplia and took her for his own evil intentions. After the purple dust had settled "+
                  ...
                  "\"Purple king Purplias Maximus, I will take this most purple of tasks and rescue the purple "+
                  "princess Purplia from the purple dragon\""
